...
(function () {
    ...
    const PAGINAS = [
        ...
        { arquivo: "training.html", icone: "🎯", nome: "Treino" },
        { arquivo: "subjects.html", icone: "📚", nome: "Matérias" },
        { arquivo: "simulator.html", icone: "📝", nome: "Simulado" },
        { arquivo: "vocabulary.html", icone: "🔤", nome: "Technical English" },
        { arquivo: "progress.html", icone: "📊", nome: "Progresso" },
        { arquivo: "historico.html", icone: "📜", nome: "Histórico" },
        { arquivo: "configuracoes.html", icone: "👤", nome: "Perfil" }
    ];
